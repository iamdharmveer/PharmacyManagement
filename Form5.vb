...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Location = New System.Drawing.Point(60, 104)
        ...
        Me.Label9.Size = New System.Drawing.Size(552, 72)
        Me.Label9.TabIndex = 10
        Me.Label9.Text = "MEDICINE DETAILS"
        ...
        Me.Panel1.Location = New System.Drawing.Point(184, 390)
        ...
        Me.Button5.Location = New System.Drawing.Point(384, 24)
        ...
        Me.Button2.Location = New System.Drawing.Point(64, 24)
        ...
        Me.ClientSize = New System.Drawing.Size(960, 470)
...
#End Region
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            cmdstr = "INSERT INTO MedicineDetails VALUES(" & TextBox1.Text & "," & TextBox3.Text & ",'" & TextBox4.Text & "','" & TextBox5.Text & "'," & TextBox6.Text & ",convert(datetime,'" & TextBox7.Text & "'),convert(datetime,'" & TextBox8.Text & "'),'" & TextBox2.Text & "')"
            cmd.CommandText = cmdstr

            cmd.ExecuteNonQuery()
            MessageBox.Show("Medicine is added successfully", "Feedback")
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        r = MessageBox.Show("Do you really want to delete current Medicine details along with all the details ", "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2)
        ...
        Dim s As String
        s = "delete from MedicineDetails where mid =" + TextBox1.Text
        cmd.CommandText = s
